...
declare namespace cfxFormat {
    export { getLogs, getLogsAdvance, transactionToAddress, signTx, callTx, callTxAdvance, status, estimate, transaction, block, receipt, epochReceipts, log, logs, supplyInfo, sponsorInfo, rewardInfo, voteList, depositList, head, revert, epoch, accountPendingInfo, accountPendingTransactions, posEconomics, voteParamsInfo, LogFilter, CallRequest, ChainStatus, EstimateResult, Transaction, Block, TransactionReceipt, Log, SupplyInfo, SponsorInfo, RewardInfo, Vote, Deposit, BlockHead, RevertNotification, epochNumber, AccountPendingInfo, AccountPendingTransactions, PoSEconomics, VoteParamsInfo };
}
